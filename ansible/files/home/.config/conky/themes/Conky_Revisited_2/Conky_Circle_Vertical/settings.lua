...
function draw_function(cr)
	...
	if battery then
		...
		draw_circle(cr,start_rect_x+gap_x_fix,start_rect_height_no_battery+gap_y_fix, start_rect_width, start_rect_height,r_CPU, g_CPU, b_CPU, transparency_CPU,conky_parse('${cpu cpu0}'))
		draw_cpu(cr,number_of_cpus,gap_x+gap_x_fix,(start_rect_height_no_battery)+gap_y_fix,r_CPU, g_CPU, b_CPU, transparency_CPU)
		start_rect_height_no_battery = start_rect_height_no_battery+108+gap_y
		draw_circle(cr,start_rect_x+gap_x_fix,(start_rect_height_no_battery)+gap_y_fix, start_rect_width, start_rect_height,r_RAM, g_RAM, b_RAM, transparency_RAM,tostring(100-tonumber(conky_parse('${memperc}'))))
