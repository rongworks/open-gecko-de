...
function draw_function(cr)
	...
	gap_x_fix = 2
   	gap_y_fix = 2
	start_rect_width_no_battery = 106
	radius = 10
    
	if battery then
 
		draw_square(cr,start_rect_x+gap_x_fix,start_rect_y+gap_y_fix, start_rect_width, start_rect_height,r_battery, g_battery, b_battery, transparency_battery)
		draw_battery(cr,gap_x+gap_x_fix, gap_y_fix,start_rect_height,r_battery, g_battery, b_battery, transparency_battery)
		
		for i=1,drives do
			draw_square(cr,(start_rect_x+start_rect_width+gap_x_distance)*i+gap_x_fix,start_rect_y+gap_y_fix, start_rect_width, start_rect_height,drive_colors[i][1], drive_colors[i][2], drive_colors[i][3], drive_colors[i][4])
		...
		draw_square(cr,(start_rect_x+start_rect_width+gap_x_distance)*(drives+1)+gap_x_fix,start_rect_y+gap_y_fix, start_rect_width, start_rect_height,r_CPU, g_CPU, b_CPU, transparency_CPU)
		...
		draw_square(cr,(start_rect_x+start_rect_width+gap_x_distance)*(drives+2)+gap_x_fix,start_rect_y+gap_y_fix, start_rect_width, start_rect_height,r_RAM, g_RAM, b_RAM, transparency_RAM)
		...
		for i=1,drives do
			draw_square(cr,(start_rect_x+start_rect_width_no_battery)+gap_x_fix,start_rect_y+gap_y_fix, start_rect_width, start_rect_height,drive_colors[i][1], drive_colors[i][2], drive_colors[i][3], drive_colors[i][4])
			...
			start_rect_width_no_battery = start_rect_width_no_battery + start_rect_x + gap_x_distance + 200
		end

		draw_square(cr,(start_rect_x+start_rect_width_no_battery)+gap_x_fix,start_rect_y+gap_y_fix, start_rect_width, start_rect_height,r_CPU, g_CPU, b_CPU, transparency_CPU)
		...
		draw_square(cr,(start_rect_x+start_rect_width_no_battery)+gap_x_fix,start_rect_y+gap_y_fix, start_rect_width, start_rect_height,r_RAM, g_RAM, b_RAM, transparency_RAM)
