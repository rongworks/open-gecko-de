...
function draw_function(cr)
	...
	gap_y_fix = 2
	radius = 10
	start_rect_height_no_battery = 50
	...
	if battery then
		...
		for i=1,drives do
			draw_square(cr,start_rect_x+gap_x_fix,(start_rect_y+start_rect_height+gap_y)*i+gap_y_fix, start_rect_width, start_rect_height,drive_colors[i][1], drive_colors[i][2], drive_colors[i][3], drive_colors[i][4])
			draw_folder(cr,start_rect_x+gap_x_fix,(start_rect_y+start_rect_height+gap_y)*i+gap_y_fix,start_rect_height,drive_paths[i],drive_names[i],drive_colors[i][1], drive_colors[i][2], drive_colors[i][3], drive_colors[i][4])
		end
		draw_square(cr,start_rect_x+gap_x_fix,(start_rect_y+start_rect_height+gap_y)*(drives+1)+gap_y_fix, start_rect_width, start_rect_height,r_CPU, g_CPU, b_CPU, transparency_CPU)
		draw_cpu(cr,number_of_cpus,gap_x+gap_x_fix,(start_rect_y+start_rect_height+gap_y)*(drives+1)+gap_y_fix,r_CPU, g_CPU, b_CPU, transparency_CPU)
		draw_square(cr,start_rect_x+gap_x_fix,(start_rect_y+start_rect_height+gap_y)*(drives+2)+gap_y_fix, start_rect_width, start_rect_height,r_RAM, g_RAM, b_RAM, transparency_RAM)
		draw_ram(cr,gap_x+gap_x_fix,(start_rect_y+start_rect_height+gap_y)*(drives+2)+10+gap_y_fix, radius, r_RAM, g_RAM, b_RAM, transparency_RAM)
	else
		for i=1,drives do
			draw_square(cr,start_rect_x+gap_x_fix,start_rect_y+start_rect_height_no_battery+gap_y_fix, start_rect_width, start_rect_height,drive_colors[i][1], drive_colors[i][2], drive_colors[i][3], drive_colors[i][4])
			draw_folder(cr,start_rect_x+gap_x_fix,(start_rect_y+start_rect_height_no_battery)+gap_y_fix,start_rect_height,drive_paths[i],drive_names[i],drive_colors[i][1], drive_colors[i][2], drive_colors[i][3], drive_colors[i][4])
			start_rect_height_no_battery = start_rect_height_no_battery + gap_y + 88 + gap_y_fix
		end
		draw_square(cr,start_rect_x+gap_x_fix,start_rect_y+start_rect_height_no_battery+gap_y_fix, start_rect_width, start_rect_height,r_CPU, g_CPU, b_CPU, transparency_CPU)
		draw_cpu(cr,number_of_cpus,gap_x+gap_x_fix,(start_rect_y+start_rect_height_no_battery)+gap_y_fix,r_CPU, g_CPU, b_CPU, transparency_CPU)
		start_rect_height_no_battery = start_rect_height_no_battery + gap_y + 88 + gap_y_fix
		draw_square(cr,start_rect_x+gap_x_fix,(start_rect_y+start_rect_height_no_battery)+gap_y_fix, start_rect_width, start_rect_height,r_RAM, g_RAM, b_RAM, transparency_RAM)
		draw_ram(cr,gap_x+gap_x_fix,(start_rect_y+start_rect_height_no_battery)+10+gap_y_fix, radius, r_RAM, g_RAM, b_RAM, transparency_RAM)
	end
end
